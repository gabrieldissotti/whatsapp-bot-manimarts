...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Manimarts: Politica de privacidade</title>
        <meta name="description" content="Manimarts: Politica de privacidade" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <h2>Política Privacidade</h2>
      <p>
        A sua privacidade é importante para nós. É política do manimarts
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site <a href="manimarts.com">manimarts</a>, e outros
      ...
      <p>
        ...
        <a
          ...
          target="_blank"
          style={{ backgroundColor: 'transparent', color: 'rgb(5, 90, 249);' }}
        >
      ...
      <p>
        ...
        informação que o manimarts oferece no site e com caráter enunciativo,
        mas não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          xenofóbica, ERROR ou azar, qualquer tipo de pornografia ilegal, de
          apologia ao terrorismo ou contra os direitos humanos;
        </li>
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do manimarts, de seus fornecedores ou terceiros, para
      ...
      <p>
        ...
        <strong>23 November 2022 23:10</strong>
      </p>
    </div>
  );
}
